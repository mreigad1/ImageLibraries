...
namespace PixelRGBTest {
	...
	int driver() {
		...
		{//test HSI -> Greyscale -> HSI
			...
			for (int i = 0; i < numTuples; i++) {
				HSIPix::pixelHSI pix1(testNums[i][0], testNums[i][1], testNums[i][2]);
				GreyscalePix::pixelGreyscale pix2 = static_cast<GreyscalePix::arithmeticalGreyscale>(pix1);
				HSIPix::pixelHSI pix3 = static_cast<HSIPix::arithmeticalHSI>(pix2);
				HSIPix::pixelHSI pix4 = static_cast<HSIPix::arithmeticalHSI>(pix1);
		...
		{//test Greyscale -> HSI -> Greyscale
			...
			for (int i = 0; i < numTuples; i++) {
				GreyscalePix::pixelGreyscale pix1(testNums[i][2]);
				HSIPix::pixelHSI pix2 = static_cast<HSIPix::arithmeticalHSI>(pix1);
				GreyscalePix::pixelGreyscale pix3 = static_cast<GreyscalePix::arithmeticalGreyscale>(pix2);
				GreyscalePix::pixelGreyscale pix4 = static_cast<GreyscalePix::arithmeticalGreyscale>(pix1);
